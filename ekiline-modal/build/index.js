...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)('ekiline-blocks/ekiline-modal', {
  ...
  edit: props => {
    ...
    const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps)({// className: 'group-modal',
    });
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)('ekiline-blocks/ekiline-modal-footer', {
  ...
  edit: () => {
    // Restringir los bloques, Cargar un preset.
    const PARENT_ALLOWED_BLOCKS = ['core/paragraph']; // Cargar un preset.
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)('ekiline-modal/ekiline-modal-close', {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Modal close button', 'ekiline-modal'),
  parent: ['ekiline-blocks/ekiline-modal-header', 'ekiline-blocks/ekiline-modal-body', 'ekiline-blocks/ekiline-modal-footer'],
  icon: 'button',
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Modal close button, customise, default shows an X.', 'ekiline-modal'),
  category: 'design',
  supports: {
    html: false,
    reusable: false,
